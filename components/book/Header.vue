...
<div class="sticky top-0 p-2.5 bg-white">
	...
	<section class="max-w-7xl mx-auto mt-1.5 grid grid-cols-[1fr_auto] md:grid-cols-[1fr_1fr_1fr] items-center">
		...
		<NuxtLink to="https://chorelesslaundry.bookingkoala.com/dashboard" class="btn btn-sm btn-ghost justify-self-end w-8 p-1.5 stroke-2 stroke-brand-orange hover:stroke-white ">
