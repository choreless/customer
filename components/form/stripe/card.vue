...
<template>
    <div>
        <div ref="cardEl" v-show="isNewCard" />
        <div v-show="!isNewCard"
            ...
            <div ref="cardDropdown" v-if="showCardDropdown"
                ...
                <ul>
                    <li class="px-2.5 py-1.5 hover:bg-[#F7FAFC] text-sm text-black flex items-center gap-2"
        ...
        <button @click="isNewCard = !isNewCard"
