...
<dialog id="my_modal_3" :class="book.pricing_modal ? 'modal-open  !bg-white sm:!bg-black/50': ''" class="modal  py-0 sm:py-3  overflow-scroll sm:overflow-hidden">
	<div class=" text-center  absolute top-0 sm:relative sm:modal-box sm:max-w-[31.313rem] w-full flex flex-col gap-2.5 sm:gap-[1.875rem] !p-0 !pb-5  !rounded-[0.313rem] !overflow-y-scroll no-scrollbar">
		...
		<div class=" text-center px-5 py-[1.125rem] bg-brand-orange font-medium sm:font-bold text-white mx-[1.875rem] rounded-[0.313rem]" @click="book.pricing_modal=false,book.extra_service=!book.extra_service">Got it</div>
	</div>
</dialog>
</template>
