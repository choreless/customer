...
export const detergents = [{value: 'Premium Scented', isPopular: false, discription: 'Top-rated Premium brand scented detergent'}, {value: 'Hypoallergenic', isPopular: false, discription: 'Detergent that is free from dyes, perfumes, scents, & optical brighteners'}, {value: 'Customer Provided', isPopular: false, discription: 'Include detergent with your laungry and we`ll use it Whatever is not used will be returned to you.'}]as const;
