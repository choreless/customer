...
<div class="flex items-center gap-4 min-h-screen">
	<div id="summary_map" class="h-full basis-[50%]">
			...
			<div class="mt-5">
				<div class="flex items-start gap-4 py-2.5">
					...
					<div>
						...
						<h4 class="text-black text-lg font-medium flex items-center gap-2">
							$35 minimum charge
							<span
								v-tooltip="{
									content:
						...
						<p class=" text-sm text-[#838383]">
							If order total exceeds minimum charge,
						...
						<div class="mt-1 space-y-2">
							<div class="space-y-2">
								...
								<form-promocode-input v-if="showPromocodeInput" v-model:promoCode="promoCode" />
							</div>
							<div class="space-y-2">
								<button
									class="flex items-center text-sm gap-3  hover:text-gray-800 transition duration-200 ease-linear"
								...
								<form-tip-input
									v-if="showTipInput" v-model:tip="tip"
				...
				<div
					class="py-4 relative space-y-8 -z-10"
				...
				>
					...
					<div v-if="!isLocationSame" class="flex items-start gap-4 py-2.5 z-10 relative group">
						<div
							class=" size-8 rounded-full items-center justify-center inline-flex shrink-0 bg-[#EDEEF1] overflow-hidden"
						>
							<span
				...
				<div
					class="relative space-y-8 transition-all duration-200 ease-linear"
				...
				>
					<div class="flex items-start gap-4 py-2.5 z-10 relative group">
						...
						<div>
							...
							<h4 class="text-black text-[18px]  flex items-center gap-2">
								Sun, Nov 12th - 9AM
								to 10AM
							</h4>
						</div>
					...
					<div class="flex items-start gap-4 py-2.5 z-10 relative group">
						...
						<div>
							...
							<h4 class="text-black text-lg flex items-center gap-2">
								Mon, Nov 13th - 9AM
								to 10 AM
							</h4>
						</div>
					...
					<div class="flex items-start gap-4 py-2.5 z-10 relative group">
						...
						<div>
							...
							<p class="text-black text-lg flex items-center gap-2 mt-1">
								Home & Bedding
							</p>
						</div>
					</div>
				...
				<button
					type="button" class="flex items-center gap-3 text-sm text-[#F85A47] hover:text-orange-700 transition duration-200 ease-linear"
